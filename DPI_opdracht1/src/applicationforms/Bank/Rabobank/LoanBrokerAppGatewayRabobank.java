...
public class LoanBrokerAppGatewayRabobank {

    private MessageRecieverGateway receiver;
    private MessageSenderGateway sender;
    private BankSerializer serializer;

    private JMSBankFrameRabobank frame;

    public LoanBrokerAppGatewayRabobank(JMSBankFrameRabobank frame)
    {
        this.frame = frame;
        sender = new MessageSenderGateway("BankInterestReply");
        receiver = new MessageRecieverGateway("BankInterestRequestRabobank");
